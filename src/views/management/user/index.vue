<template>
  <AppPage>
    <n-card title="用户管理" :bordered="false" class="rounded-16px shadow-sm">
      ...
      <table-action-modal v-model:isShowModal="isShowModal" :type="modalType" :edit-data="editData" />
    </n-card>
  </AppPage>
</template>
...
<script setup lang="jsx">
  ...
  import { fetchUserList } from '@/config'
  import { genderLabels, userStatusLabels } from '@/config'
