    ...
    <n-card title="项目主要技术栈" :bordered="false" size="small" class="shadow-sm rounded-16px">
      <template #header-extra>
        <n-button type="primary" @click="handleAdd">
          <SvgIcon icon="material-symbols:add" :size="18" class="mr-5" /> 新建文章
        </n-button>
      </template>
...
<script setup>
  ...
  import { fetchAddPost, fetchDeletePost, fetchUpdatePost, fetchGetPost } from '@/api'
  ...
  const {
    ...
    name: '文章',
    initForm: { author: 'DirtyWei' },
    doCreate: fetchAddPost,
    doDelete: fetchDeletePost,
    doUpdate: fetchUpdatePost,
