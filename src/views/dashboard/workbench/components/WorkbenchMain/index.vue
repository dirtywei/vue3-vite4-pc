<template>
  <n-grid :item-responsive="true" :x-gap="16" :y-gap="16">
    <n-grid-item span="0:24 640:24 1030:16">
...
<script setup>
  ...
  const activity = [
    { id: 4, content: 'DirtyWei 刚才把工作台页面随便写了一些，凑合能看了！', time: '2021-11-07 22:45:32' },
    { id: 3, content: 'DirtyWei 正在忙于为vue3-vite-project写项目说明文档！', time: '2021-11-03 20:33:31' },
    { id: 2, content: 'DirtyWei 准备为vue3-vite-project 1.0的发布做充分的准备工作！', time: '2021-10-31 22:43:12' },
    { id: 1, content: '@yanbowe 向vue3-vite-project提交了一个bug，多标签栏不会自适应。', time: '2021-10-27 10:24:54' },
    { id: 0, content: 'DirtyWei 在2021年5月28日创建了开源项目vue3-vite-project！', time: '2021-05-28 22:22:22' }
  ]
